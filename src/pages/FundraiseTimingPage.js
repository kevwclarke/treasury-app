...
export function FundraiseTimingPage() {
  ...
  const traffic =
    runwayMo >= 18 ? { color: '#1B2B8C', label: 'Green' } : runwayMo >= 12 ? { color: '#D97706', label: 'Amber' } : { color: '#DC2626', label: 'Red' }
  ...
  return (
    <div className="detail-page">
      ...
      <section className="detail-section">
        ...
        <p className="detail-stat__val" style={{ fontSize: '1.75rem', color: isPast ? '#DC2626' : '#1B2B8C' }}>
