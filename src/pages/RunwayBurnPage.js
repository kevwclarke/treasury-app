        ...
        {loading ? (
          ...
          <>
            ...
            <div className="detail-grid3">
              ...
              >
                <p className="detail-stat__cap" style={{ color: '#DC2626' }}>
                  Bear
                </p>
              ...
              >
                <p className="detail-stat__cap" style={{ color: '#6B7280' }}>
                  Base
                </p>
                <p className="detail-stat__val" style={{ color: '#0F0F0F' }}>
